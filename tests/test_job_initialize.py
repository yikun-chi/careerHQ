"""
Test suite for job_initialize module.

Tests the loading of OrganizationRegistry, ScaleDefinitions, and Elements.
Run with: pytest tests/test_job_initialize.py -v -s
"""
...
from packages.core.domain.job_initialize_1a import (
...
from packages.core.domain.job_initialize_1b import (
...
from packages.core.domain.job_initialize_1d import (
...
from packages.core.domain.job_initialize_2abc import (
...
from packages.core.domain.job_initialize_2d3a import (
